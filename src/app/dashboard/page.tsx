        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative mb-10 space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Manage your workspace, generate reports, and keep an eye on system
              health.
            </p>
          </div>
            ...
            <div className="relative flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div className="space-y-2">
                ...
                <p className="max-w-xl text-muted-foreground">
                  Upload an X-ray to create a structured radiology draft. Review
                  with AI assistance before signing off.
                </p>
              </div>
