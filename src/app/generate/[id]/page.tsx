...
export default async function Page({ params }: any) {
  ...
  const report = await getReportById((await params).id);
      ...
      <header className="sticky top-0 z-10 border-b border-white/10 bg-slate-950/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 text-white">
          ...
          <nav className="hidden items-center gap-6 text-sm font-medium text-slate-200 md:flex">
            ...
            <a href="/preprocess" className="hover:text-white">Preprocess</a>
            <a href="/generate" className="text-white">Generate</a>
      ...
      <div className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-6 pb-14 pt-10">
          <div className="space-y-3 text-white">
            <p className="text-xs uppercase tracking-[0.14em] text-blue-200">Workspace</p>
            <h1 className="text-3xl font-semibold">Report generation session</h1>
            <p className="max-w-3xl text-sm text-slate-200">
              Review and refine the AI-drafted report. All edits stay local to this secure workspace until you publish.
            </p>
          </div>
